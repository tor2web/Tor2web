<html xmlns:t="http://twistedmatrix.com/ns/twisted.web.template/0.1">
  <head>
  <title>Tor2web Error: Blocked User Agent</title>
  ...
  <div id="tor2web-wrapper">
    ...
    <div id="tor2web-content">
      <h2 id="tor2web-title">Tor2web Error: Blocked User Agent</h2>
      <p>Access to this url has been blocked for the current user agent.</p>
    </div>
  </div>
  </body>
</html>
